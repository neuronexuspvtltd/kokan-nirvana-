      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div>
          ...
          <input
            ...
            className={`w-full px-4 py-3 rounded-xl text-xs sm:text-sm bg-brand-cyan-tint/40 border ${phoneError ? 'border-red-500 focus:border-red-500' : 'border-brand-cyan/20 focus:border-brand-cyan'} focus:outline-none focus:bg-white text-brand-slate font-medium`}
          />

  ...
  return (
    <section className="relative min-h-screen min-h-[100dvh] h-screen flex flex-col justify-center items-center pt-20 pb-12 sm:pt-32 sm:pb-20 overflow-hidden bg-slate-950">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white flex flex-col items-center justify-center my-auto">
        ...
        {/* Eyebrow Pill */}
        <div className="inline-flex items-center gap-1.5 px-3 py-1 sm:px-4 sm:py-1 rounded-full text-[10px] sm:text-[11px] font-bold tracking-wider sm:tracking-widest uppercase bg-white/15 backdrop-blur-md border border-white/25 text-brand-cyan-light mb-4 sm:mb-6 shadow-sm">
        ...
        <h1 className="font-serif text-3xl sm:text-6xl md:text-7xl font-bold tracking-tight text-white leading-tight sm:leading-[1.1] drop-shadow-lg max-w-3xl">
          ...
          <span className="font-normal italic text-2xl sm:text-5xl md:text-6xl text-gray-100 font-serif block sm:inline mt-1 sm:mt-0">
            Worth Calling Home
          </span>
        </h1>
        ...
        <p className="mt-4 sm:mt-6 text-xs sm:text-lg text-gray-200 font-sans font-normal max-w-xs sm:max-w-2xl leading-relaxed drop-shadow font-medium px-2 sm:px-0">
          Curated properties. Exceptional locations. A lifestyle beyond the ordinary along the pristine Maharashtra Konkan coast.
        </p>
      ...
      <a 
        href="#about"
        className="relative z-10 pb-4 flex flex-col items-center text-white/70 hover:text-white transition-colors cursor-pointer"
      >
